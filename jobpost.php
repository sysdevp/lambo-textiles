 ...
 <button name = "go" class="btn btn-primary">Save</button>
                     ...
                     <?php include ('admin/connect.php');
                            if (isset($_POST['go'])) {
                                ...
                                mysql_query("insert into jobpost(name,email,phone,experience,qualification,expected,cname,position,message)values ('$name', '$email', '$phone', '$experience', '$qualification', '$expected', '$cname', '$position', '$message')
                                ") or die(mysql_error());
    ...
    <section id="content" style="padding-bottom:0px;padding-top:0px; background-color: white; ">
            ...
            <div class=" table-responsive">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php include ('admin/connect.php');
                                    $query = mysql_query("select * from jobpost") or die(mysql_error());
